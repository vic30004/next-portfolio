...
export default ({ location }) => {
  ...
  useEffect(() => {
    const loc = location();
    console.log(loc);
    setCountry(Promise.resolve(loc));
  }, []);
  return (
    <section id='about'>
      ...
      <div className='card-container'>
        <div className='card'>
          ...
          <h2>SEO</h2>
          <p>
            What's the point of creating a great website when no one can find
            it? This is why focusing on SEO is one of my top priorities.
          </p>
        </div>
        <div className='card'>
          <div className='logo'>
          ...
          <p>
            ...
            to create the best user interface and provide the best user
            experience to allow for the backend to shine and to make sure every
            user has a memorable experience.
          </p>
        </div>
        <div className='card'>
          <div className='logo'>
